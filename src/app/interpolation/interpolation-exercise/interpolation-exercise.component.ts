...
@Component({
  selector: 'app-interpolation-exercise',
  templateUrl: './interpolation-exercise.component.html',
  styleUrls: ['./interpolation-exercise.component.scss']
})
export class InterpolationExerciseComponent {
  title = 'ćwiczenia';
  num1 = 40;
  num2 = '4';
  falsity = false;
